...
class PictureMusic extends StatefulWidget {
  const PictureMusic({super.key});

  @override
  State<PictureMusic> createState() => _PictureMusicState();
}

class _PictureMusicState extends State<PictureMusic> {
  final player = AudioPlayer();
  Music music = Music(trackId: '7gdRZLMXECnJ8HnZYm5N23');
      ...
      if (tempSongName != null) {
        ...
        try {
          ...
          await player.setSource(UrlSource(
              'https://firebasestorage.googleapis.com/v0/b/musicapp-19ecb.appspot.com/o/picture.mp3?alt=media&token=28ccba48-77d5-4f98-a408-354469c7c5f7')); // Set audio source
