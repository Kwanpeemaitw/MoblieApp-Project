...
class NoMatterWhatMusic extends StatefulWidget {
  const NoMatterWhatMusic({super.key});

  @override
  State<NoMatterWhatMusic> createState() => _NoMatterWhatMusicState();
}

class _NoMatterWhatMusicState extends State<NoMatterWhatMusic> {
  final player = AudioPlayer();
  Music music = Music(trackId: '7gPJ0LnpLQOhqH1Gx13cwv');
      ...
      if (tempSongName != null) {
        ...
        try {
          ...
          await player.setSource(UrlSource(
              'https://firebasestorage.googleapis.com/v0/b/musicapp-19ecb.appspot.com/o/nomatterwhat.mp3?alt=media&token=154f4072-52a3-4078-8b56-b3b42b4ada9f')); // Set audio source
