...
class TransformerMusic extends StatefulWidget {
  const TransformerMusic({super.key});

  @override
  State<TransformerMusic> createState() => _TransformerMusicState();
}

class _TransformerMusicState extends State<TransformerMusic> {
  final player = AudioPlayer();
  Music music = Music(trackId: '79gZEEThebUtPiqGLHMupL');
      ...
      if (tempSongName != null) {
        ...
        try {
          ...
          await player.setSource(UrlSource(
              'https://firebasestorage.googleapis.com/v0/b/musicapp-19ecb.appspot.com/o/transformers.mp3?alt=media&token=b9893e7a-b9ee-4fc5-9dec-071014da60af')); // Set audio source
