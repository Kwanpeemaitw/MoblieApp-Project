...
class WatchyourstepMusic extends StatefulWidget {
  const WatchyourstepMusic({super.key});

  @override
  State<WatchyourstepMusic> createState() => _WatchyourstepMusicState();
}

class _WatchyourstepMusicState extends State<WatchyourstepMusic> {
  final player = AudioPlayer();
  Music music = Music(trackId: '6N1ZqtABCgsqotshwnvEk1');
      ...
      if (tempSongName != null) {
        ...
        try {
          ...
          await player.setSource(UrlSource(
              'https://firebasestorage.googleapis.com/v0/b/musicapp-19ecb.appspot.com/o/watchyourstep.mp3?alt=media&token=bacc1642-d9bc-43ed-83c8-53a079beda11')); // Set audio source
