...
class BrotherZoneMusic extends StatefulWidget {
  const BrotherZoneMusic({super.key});

  @override
  State<BrotherZoneMusic> createState() => _BrotherZoneMusicState();
}

class _BrotherZoneMusicState extends State<BrotherZoneMusic> {
  final player = AudioPlayer();
  Music music = Music(trackId: '08NGk13plUmQ5E5yjxIPIz');
      ...
      if (tempSongName != null) {
        ...
        try {
          ...
          await player.setSource(UrlSource(
              'https://firebasestorage.googleapis.com/v0/b/musicapp-19ecb.appspot.com/o/brotherzone.mp3?alt=media&token=11e9654d-f3d2-4ca6-be08-6b3fc4f009bd')); // Set audio source
