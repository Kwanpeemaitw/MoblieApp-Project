              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const LiarMusic()), // เปลี่ยนไปยัง SecondPage
                  );
                },
                child: Container(
                  width: 350,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TransformerMusic()),
                  );
                },
                child: Container(
                  width: 350,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const FeelingoohMusic()),
                  );
                },
                child: Container(
                  width: 350,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const WatchyourstepMusic()),
                  );
                },
                child: Container(
                  width: 350,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const PictureMusic()), // เปลี่ยนไปยัง SecondPage
                  );
                },
                child: Container(
                  width: 350,
